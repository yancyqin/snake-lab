...
- [ ] **🎓 Secret Lesson** — when a kid clears **Level 10**, they've earned the [Secret Lesson](SECRET_LESSON.md) (how to beat Achilles: find its weakness + ML tuning). Offer it as a bonus 1-on-1. Don't show the answer bot (private in `snake-lab-ml`); guide with questions.
